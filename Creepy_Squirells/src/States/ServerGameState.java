<<<<<<< Updated upstream:Creepy_Squirells/src/States/ServerGameState.java
package States;
...
//		}
		...
		if(select_2){
			...
			if( gc.getInput().isMouseButtonDown(Input.MOUSE_LEFT_BUTTON))
			{
				...
				if (flag_r && gc.getInput().isKeyPressed(Input.KEY_RIGHT)) {
...
>>>>>>> Stashed changes:Creepy_Squirells/src/States/GameState.java
